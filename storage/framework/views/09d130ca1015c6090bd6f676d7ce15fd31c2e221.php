         ...
         <div class="container">
            <div class="row">
               <div class="col-md-5">
                  <!-- Logo -->
                  <div class="logo">
                     <h1><a href="<?php echo e(route('admin/dashboard')); ?>">Administrador</a></h1>
                  </div>
               </div>
               <div class="col-md-5">
                  <div class="row">
                  ...
                  <div class="navbar navbar-inverse" role="banner">
                      <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                        <ul class="nav navbar-nav">
                          <li><a href="<?php echo e(route('admin/dashboard')); ?>">Administrador</a></li>
                        </ul>
                      </nav>
                  </div>
               </div>
          ...
          <div class="col-md-2">
            <div class="sidebar content-box" style="display: block;">
              ...
              <ul class="list-group">
                  ...
                  <li class="list-group-item">
                    <a href="<?php echo e(route('admin/jugos')); ?>"> Jugos</a>
                  </li>
                  <li class="list-group-item">
                    Opción 1
                  </li>
          ...
          <div class="col-md-12">
              ...
              <div class="content-box-large">
                ...
                <div class="panel-body">
                  ...
                  <a href="<?php echo e(route('admin/jugos/crear')); ?>" class="btn btn-success mt-4 ml-3">  Agregar
                  </a>
                                  ...
                                  <section class="example mt-4">
                                    ...
                                    <div class="table-responsive">
                                      ...
                                      <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                          <?php $__currentLoopData = $jugos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <tr>
                                            <td class="v-align-middle"><?php echo e($jug->nombre); ?></td>
                                            <td class="v-align-middle"><?php echo e($jug->precio); ?></td>
                                            <td class="v-align-middle"><?php echo e($jug->stock); ?></td>
                                            <td class="v-align-middle">
                                              <img src="<?php echo asset("uploads/$jug->img"); ?>" width="30" class="img-responsive">
                                            </td>
                                            <td class="v-align-middle">

                                              <form action="<?php echo e(route('admin/jugos/eliminar',$jug->id)); ?>" method="POST" class="form-horizontal" role="form" onsubmit="return ConfirmarEliminar()">

                                                <input type="hidden" name="_method" value="PUT">
                                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">                                            
                                                <a href="<?php echo e(route('admin/jugos/actualizar',$jug->id)); ?>" class="btn btn-primary">Editar</a>          
...
<?php /**PATH D:\xampp\htdocs\tutoriales\miaplicacioncrud\resources\views/admin/jugos/index.blade.php ENDPATH**/ ?>
      ...
      <div class="page-content">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin/jugos')); ?>">Jugos</a></li>
              ...
              <div class="content-box-large">
                ...
                <div class="panel-body">
                    ...
                    <section class="example mt-4">
                      ...
                      <form method="POST" action="<?php echo e(route('admin/jugos/update',$jugos->id)); ?>" role="form" enctype="multipart/form-data">

                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">

                        <?php echo $__env->make('admin.jugos.frm.prt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\xampp\htdocs\tutoriales\miaplicacioncrud\resources\views/admin/jugos/actualizar.blade.php ENDPATH**/ ?>